...
// ALU: BARRIER;
    ...
    // R127.x == 1 ?
    PREDE_INT: DST_CHAN.CHAN_X UPDATE_PRED
        SRC0_SEL.GPR(127) SRC0_CHAN.CHAN_X
        SRC1_SEL.ALU_SRC_1_INT SRC1_CHAN.CHAN_X LAST;
    // && R127.y == 0 ?
    PREDE_INT: DST_CHAN.CHAN_Y UPDATE_PRED
        SRC0_SEL.GPR(127) SRC0_CHAN.CHAN_Y
        SRC1_SEL.ALU_SRC_0 SRC1_CHAN.CHAN_Y LAST PRED_SEL.PRED_SEL_ONE;
    // || R127.z == 1 ?
    PREDE_INT: DST_CHAN.CHAN_Z UPDATE_PRED
        SRC0_SEL.GPR(127) SRC0_CHAN.CHAN_Z
        SRC1_SEL.ALU_SRC_1_INT SRC1_CHAN.CHAN_Z LAST PRED_SEL.PRED_SEL_ZERO;

    // R2.x <- pred ? 0xdead0000 : 0xbeef0000
    MOV: DST_GPR(2) DST_CHAN.CHAN_X
        SRC0_SEL.ALU_SRC_LITERAL SRC0_CHAN.CHAN_X WRITE_MASK PRED_SEL.PRED_SEL_ONE;
    MOV: DST_GPR(2) DST_CHAN.CHAN_X
        SRC0_SEL.ALU_SRC_LITERAL SRC0_CHAN.CHAN_Y WRITE_MASK LAST PRED_SEL.PRED_SEL_ZERO;
    0xdead0000 0xbeef0000;
