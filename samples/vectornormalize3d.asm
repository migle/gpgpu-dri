...
ALU: BARRIER;
    ...
    DOT_IEEE: DST_CHAN.CHAN_X
        SRC0_SEL.GPR(2) SRC0_CHAN.CHAN_X
        SRC1_SEL.GPR(2) SRC1_CHAN.CHAN_X;
    DOT_IEEE: DST_CHAN.CHAN_Y
        SRC0_SEL.GPR(2) SRC0_CHAN.CHAN_Y
        SRC1_SEL.GPR(2) SRC1_CHAN.CHAN_Y;
    DOT_IEEE: DST_CHAN.CHAN_Z
        SRC0_SEL.GPR(2) SRC0_CHAN.CHAN_Z
        SRC1_SEL.GPR(2) SRC1_CHAN.CHAN_Z LAST;

    RECIPSQRT_IEEE: SRC0_SEL.ALU_SRC_PV LAST;

    MUL_IEEE: DST_CHAN.CHAN_X DST_GPR(3) WRITE_MASK
        SRC0_SEL.ALU_SRC_PS
        SRC1_SEL.GPR(2) SRC1_CHAN.CHAN_X;
    MUL_IEEE: DST_CHAN.CHAN_Y DST_GPR(3) WRITE_MASK
        SRC0_SEL.ALU_SRC_PS
        SRC1_SEL.GPR(2) SRC1_CHAN.CHAN_Y;
    MUL_IEEE: DST_CHAN.CHAN_Z DST_GPR(3) WRITE_MASK
        SRC0_SEL.ALU_SRC_PS
        SRC1_SEL.GPR(2) SRC1_CHAN.CHAN_Z;
    MOV: DST_CHAN.CHAN_W DST_GPR(3) WRITE_MASK
        SRC0_SEL.ALU_SRC_1 LAST;
